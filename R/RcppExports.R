...
read_ws_d <- function(path, shared_strings) {
    .Call(`_openxlsx_read_ws_d`, path, shared_strings)
}

read_shared_strings <- function(path) {
    .Call(`_openxlsx_read_shared_strings`, path)
}
