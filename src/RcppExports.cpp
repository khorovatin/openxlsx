...
RcppExport SEXP _openxlsx_read_ws_d(SEXP pathSEXP, SEXP shared_stringsSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type path(pathSEXP);
    Rcpp::traits::input_parameter< Rcpp::DataFrame >::type shared_strings(shared_stringsSEXP);
    rcpp_result_gen = Rcpp::wrap(read_ws_d(path, shared_strings));
    return rcpp_result_gen;
END_RCPP
}
// read_shared_strings
Rcpp::DataFrame read_shared_strings(std::string path);
RcppExport SEXP _openxlsx_read_shared_strings(SEXP pathSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type path(pathSEXP);
    rcpp_result_gen = Rcpp::wrap(read_shared_strings(path));
    return rcpp_result_gen;
END_RCPP
}
// set_row
...
SEXP write_worksheet_xml_2(std::string prior, std::string post, Reference sheet_data, Nullable<CharacterVector> row_heights_, Nullable<CharacterVector> outline_levels_, std::string R_fileName);
RcppExport SEXP _openxlsx_write_worksheet_xml_2(SEXP priorSEXP, SEXP postSEXP, SEXP sheet_dataSEXP, SEXP row_heights_SEXP, SEXP outline_levels_SEXP, SEXP R_fileNameSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< std::string >::type prior(priorSEXP);
    ...
    Rcpp::traits::input_parameter< std::string >::type R_fileName(R_fileNameSEXP);
    rcpp_result_gen = Rcpp::wrap(write_worksheet_xml_2(prior, post, sheet_data, row_heights_, outline_levels_, R_fileName));
    return rcpp_result_gen;
END_RCPP
}
...
static const R_CallMethodDef CallEntries[] = {
    ...
    {"_openxlsx_read_ws_d", (DL_FUNC) &_openxlsx_read_ws_d, 2},
    {"_openxlsx_read_shared_strings", (DL_FUNC) &_openxlsx_read_shared_strings, 1},
